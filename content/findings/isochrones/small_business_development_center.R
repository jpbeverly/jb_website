...
Small_Business_Development_Centers <- read_csv("Small_Business_Development_Centers.csv")
...
# small_business_plot <- leaflet(data = small_business_data) %>% # create leaflet object
...
# small_business_dev_iso_20_index_1 <- traveltime_map(appId= traveltime_id,
#                                          apiKey = traveltime_api,
#                                          location=c(small_business_data$Latitude[1], small_business_data$Longitude[1]),
#                                          traveltime=1200,
#                                          type="driving",
...
# saveRDS(small_business_dev_iso_20_index_1, file = paste0('small_business_dev_iso_20_index_1','.RDS'))
...
small_business_dev_iso_20_index_1 <- readRDS("small_business_dev_iso_20_index_1.RDS")
